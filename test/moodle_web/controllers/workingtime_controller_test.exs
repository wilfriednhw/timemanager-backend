defmodule MoodleWeb.WorkingtimeControllerTest do
  use MoodleWeb.ConnCase
  ...
  @update_attrs %{
    end: ~N[2021-10-26 12:29:00],
    start: ~N[2021-10-26 12:29:00]
  }
  ...
  describe "create workingtime" do
    test "renders workingtime when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-10-25T12:29:00",
               "start" => "2021-10-25T12:29:00"
  ...
  describe "update workingtime" do
    ...
    test "renders workingtime when data is valid", %{conn: conn, workingtime: %Workingtime{id: id} = workingtime} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-10-26T12:29:00",
               "start" => "2021-10-26T12:29:00"
             } = json_response(conn, 200)["data"]
    end
